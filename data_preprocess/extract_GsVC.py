...
def sensifunc_slice(project, _dict):
    ...
    store_filepath = f"./GsVCs/{project}/"
            ...
            if sensitive_funcname.find("main") != -1:
                ...
                if list_code == []:
                    ...
                    for _list in list_code:
                        ...
                        count += 1
                        print(count)
    save_data.to_json(store_filepath + "sensifunc_GsVCs.json")
        ...
        for _t in dict_unsliced_variables[key]:
            ...
            if list_code == []:
                ...
                for _list in list_code:
                    ...
                    count += 1
                    print(count)
    save_data.to_json(store_filepath + "sensivar_GsVCs.json")
        ...
        for _t in dict_unsliced_expr[key]:
            ...
            if list_code == []:
                ...
                for _list in list_code:
                    ...
                    count += 1
                    print(count)
    save_data.to_json(store_filepath + "expression_GsVCs.json")
...
if __name__ == "__main__":
    ...
    # 合并多个json文件
    file1 = pd.read_json(open(f'./GsVCs/{project}/sensifunc_GsVCs.json'))
    file2 = pd.read_json(open(f'./GsVCs/{project}/sensivar_GsVCs.json'))
    file3 = pd.read_json(open(f'./GsVCs/{project}/expression_GsVCs.json'))
    ...
    data_input.to_json(f"./GsVCs/{project}/{project}_GsVCs.json")
