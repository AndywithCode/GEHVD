...
import torch
from src.models.vd import GEHVD
from src.datas.datamodules import IDGDataModule
...
def test(checkpoint_path: str, data_folder: str = None, batch_size: int = None):
    ...
    """
    filter_warnings()
    model = GEHVD.load_from_checkpoint(checkpoint_path)
    ...
    data_module = IDGDataModule(config, vocabulary)
